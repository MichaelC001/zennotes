...
export const KEYMAP_CATALOG: KeymapCatalogEntry[] = [
  ...
  { id: "editor.foldHeading", group: "view-actions", defaultBinding: "Ctrl+Alt+F", defaultBindingMac: "Mod+Alt+F", title: "Fold heading" },
  { id: "editor.unfoldHeading", group: "view-actions", defaultBinding: "Ctrl+Alt+U", defaultBindingMac: "Mod+Alt+U", title: "Unfold heading" },
