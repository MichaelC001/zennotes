...
export const HELP_SHORTCUT_SECTIONS: HelpShortcutSection[] = [
  {
    ...
    items: [
      ...
      { keys: 'Shift+Enter (in Search notes)', action: 'Create a note named after your search', detail: 'When no note carries the name you typed, the last row of the results offers to create it: Shift+Enter (or Enter on that row) makes the note in your Inbox and opens it in the editor. Type a path like projects/roadmap to nest it under Inbox, or archive/old to pick another top folder; the row shows where the note will land. When a note with that exact name already exists, Shift+Enter opens it instead. #tag words in the search only filter and are never added to the new note.' },
  ...
  },
  {
    ...
    items: [
      ...
      { keys: 'Space f', action: 'Search notes', detail: 'Open the vault-wide note search palette. Inside it, Shift+Enter creates the note you searched for when no note has that name yet.' },
